...
REJECT LIMIT 0;
-- '
--Reading from avenger table
SELECT * FROM avenger;

--Drop the file_list table
...
UPDATE item i
SET text_file_name = 'HarryPotter4.txt' 
WHERE item_title = 'Harry Potter and the Goblet of Fire';
UPDATE item i
...
-- get item_id from partial_title
  CURSOR get_item_id
...
-- call the procedure parameter
EXECUTE update_item_description('Harry Potter');

-- Confirm that the procedure works
